...
## News
- [2024.07.21] v0.2.0 Added support for gemma-2 and mistral-nemo. Added multiple gpu (`--main-gpu 0`, `--split-mode none`, `--tensor-split 0.5,0.5`). Added `--instruct-preset gemma`. More details in release.
